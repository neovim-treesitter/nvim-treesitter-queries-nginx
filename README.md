# nvim-treesitter-queries-nginx

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-nginx/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-nginx/actions/workflows/validate.yml)

Neovim tree-sitter queries for **nginx**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-nginx",
...
- [ ] Changes are scoped to `nginx` — do not include files for other languages
